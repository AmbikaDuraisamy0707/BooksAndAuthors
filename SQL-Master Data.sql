-- Insert Records to Books Table

Insert into Books values ('Taxman Publications Limited','Queen Of Eternity','Elly','Griffiths',350)
Insert into Books values ('Orient Longman', 'Doctors Of Hopes', 'James', 'Patterson',1250)
Insert into Books values ('National Book Trust India','The Pure Mermide', 'Lee', 'Child	',500)
Insert into Books values ('S. Chand Publishing', 'The Lords of the Rings', 'Val ', 'McDermid',460)
Insert into Books values ('Hachette India Publishers','The Red Kingdom', 'David','Baldacci'	,150)
Insert into Books values ('Random House India','Inspiration Without Honour', 'LJ', 'Ross',	670)
Insert into Books values ('Harper Collins Publishers', 'Duke Of Darkness', 'Peter', 'James',880)
